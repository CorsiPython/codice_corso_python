...
with sql.connect("biblioteca.db") as db:
    ...
    books = [
        ...
        {
            "titolo": "The Adventures of Huckleberry Finn",
            "autore": "Mark Twain",
            "anno": 1884,
            "disponibile": 0,
        },
    ...
    print(presta_libro(cursor, PK("Hamlet", "William Shakespeare", 1603)))
